...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getLuckyControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\LuckyController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dH+kup-TzD', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OeExL3n55a', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\HizmetRepository' => ['privates', 'App\\Repository\\HizmetRepository', 'getHizmetRepositoryService', false],
            'App\\Repository\\ProductRepository' => ['privates', 'App\\Repository\\ProductRepository', 'getProductRepositoryService', false],
        ], [
            'App\\Repository\\HizmetRepository' => '?',
    ...
    /**
     * Gets the private '.service_locator.Psr0QBP' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Psr0QBPService()
    {
        return $this->privates['.service_locator.Psr0QBP'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ProductController::new' => ['privates', '.service_locator.mD9B.ud', 'get_ServiceLocator_MD9B_UdService', false],
            'App\\Controller\\ProductController:new' => ['privates', '.service_locator.mD9B.ud', 'get_ServiceLocator_MD9B_UdService', false],
        ], [
    ...
    protected function getCreateUserCommandService()
    {
        ...
        $instance->setName('app:Console-app');

        return $instance;
    }

    /**
     * Gets the private 'App\Repository\HizmetRepository' shared autowired service.
     *
     * @return \App\Repository\HizmetRepository
     */
    protected function getHizmetRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HizmetRepository.php';

        return $this->privates['App\\Repository\\HizmetRepository'] = new \App\Repository\HizmetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'MessageGenerator.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'NumberGenerator.php';

        return $this->privates['App\\Service\\MessageGenerator'] = new \App\Service\MessageGenerator(new \App\Service\NumberGenerator());
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XsgR5k-ORu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.Psr0QBP'] ?? $this->get_ServiceLocator_Psr0QBPService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder65d5f = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6bd02 = null;
    ...
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getConnection', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getMetadataFactory', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getExpressionBuilder', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'beginTransaction', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getCache', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getCache();
    }

    public function transactional($func)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'transactional', array('func' => $func), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'wrapInTransaction', array('func' => $func), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'commit', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->commit();
    }

    public function rollback()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'rollback', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getClassMetadata', array('className' => $className), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'createQuery', array('dql' => $dql), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'createNamedQuery', array('name' => $name), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'createQueryBuilder', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'flush', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'clear', array('entityName' => $entityName), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->clear($entityName);
    }

    public function close()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'close', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->close();
    }

    public function persist($entity)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'persist', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'remove', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'refresh', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'detach', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'merge', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getRepository', array('entityName' => $entityName), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'contains', array('entity' => $entity), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getEventManager', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getConfiguration', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'isOpen', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getUnitOfWork', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getProxyFactory', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'initializeObject', array('obj' => $obj), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'getFilters', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'isFiltersStateClean', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'hasFilters', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return $this->valueHolder65d5f->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer6bd02 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder65d5f) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder65d5f = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder65d5f->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, '__get', ['name' => $name], $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        if (isset(self::$publicProperties87a1b[$name])) {
            return $this->valueHolder65d5f->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder65d5f;
    ...
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;
    ...
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, '__isset', array('name' => $name), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;
    ...
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, '__unset', array('name' => $name), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;
    ...
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, '__clone', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        $this->valueHolder65d5f = clone $this->valueHolder65d5f;
    }

    public function __sleep()
    {
        $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, '__sleep', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;

        return array('valueHolder65d5f');
    }
    ...
    {
        $this->initializer6bd02 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer6bd02;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer6bd02 && ($this->initializer6bd02->__invoke($valueHolder65d5f, $this, 'initializeProxy', array(), $this->initializer6bd02) || 1) && $this->valueHolder65d5f = $valueHolder65d5f;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder65d5f;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder65d5f;
    }
}
